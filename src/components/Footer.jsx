...
export default function Footer() {
  return (
    <footer className="text-simple-dark border-t border-orange-accent-light/30" style={{ backgroundColor: '#fff8f2' }}>
      <div className="container mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:text-right">
            ...
            <div className="flex items-center gap-4 mt-2 md:justify-end">
              ...
              <a href="#" aria-label="Facebook" className="text-orange-accent-dark hover:text-orange-accent-light transition-colors" title="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="LinkedIn" className="text-orange-accent-dark hover:text-orange-accent-light transition-colors" title="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center text-sm text-orange-accent-dark/80 mt-8">
